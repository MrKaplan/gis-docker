...
├── 📁.github/
│   └── workflows/
│       ├── deploy.yml                   # Deploy stack para Oracle Cloud
│       └── hugo-deploy.yml              # Build e deploy Hugo
└── 📄 README.md
```
...
│   │   ├── static/
│   │   ├── themes/
│   │   └── public/                      # OUTPUT (gerado pelo Hugo)
│   │
...
└── docs/                                # Documentação
    ...
    ├── 06_NUCLEO_AGRICOLA.md
    ├── 07_NUCLEO_HIDRICO.md
    ├── 08_NUCLEO_URBANO.md
    ├── 09_NUCLEO_CARSICO.md
    ├── 10_NUCLEO_FLORESTAL_RISCOS.md
    ├── 11_NUCLEO_TURISMO_PATRIMONIO.md
    ├── 12_ANCHOR_PROJECTS.md
    ├── 13_BIBLIOGRAFIA.md
    ├── 14_DADOS_NECESSARIOS.md
    ├── 15_PROXIMOS_PASSOS.md
    └── 99_STATUS.md
```
